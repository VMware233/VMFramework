...
namespace VMFramework.Containers
{
    public partial class ContainerManager
    {
        ...
        [Client]
        public static void AddOrSwapItem(Container fromContainer, int fromSlotIndex, Container toContainer,
            int toSlotIndex)
        {
        ...
        [Client]
        public static void SplitItemTo(Container fromContainer, int fromSlotIndex, int count,
