...
namespace VMFramework.Core
{
    public partial struct CubeFloat
    {
        ...
        public static implicit operator (Vector3 min, Vector3 max)(CubeFloat cube) => (cube.min, cube.max);
        
        public static implicit operator CubeFloat((Vector3 min, Vector3 max) tuple) => new(tuple.min, tuple.max);
    }
}