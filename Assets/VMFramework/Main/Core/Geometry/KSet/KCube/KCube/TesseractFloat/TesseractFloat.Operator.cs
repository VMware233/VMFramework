...
namespace VMFramework.Core
{
    public partial struct TesseractFloat
    {
        ...
        public void Deconstruct(out Vector4 min, out Vector4 max)
        {
            min = this.min;
            max = this.max;
        }
        ...
        public static implicit operator (Vector4 min, Vector4 max)(TesseractFloat tesseract) =>
            (tesseract.min, tesseract.max);

        public static implicit operator TesseractFloat((Vector4 min, Vector4 max) tesseract) =>
            new(tesseract.min, tesseract.max);
    }
}